      ...
      <div className="subscribe">
        ...
        <form className="flex flex-col sm:flex-row gap-3 w-10/12 sm:w-8/12">
          <input
            ...
            className="flex-1 px-4 py-2 rounded-lg text-gray-900 input input-bordered input-primary"
          />

          <button
            type="submit"
            className="bg-white text-[#4C4CEA] font-semibold px-6 py-2 rounded-lg hover:bg-opacity-90 transition cursor-pointer"
          >
            Subscribe
          </button>
        </form>
